            ...
            <div class="col">
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <h2 class="mb-0">Neraca</h2>
                        <p class="mb-0 text-sm">Kelola Neraca</p>
                        ...
                        <table class="table table-hover table-sm table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Laba Bersih </td>
                                    <td class="text-left laba-bersih">{{ 'Rp. ' . substr(number_format($laba, 2, ',', '.'),0,-3) }}</td>
                                    <td></td>
                                    <td></td>
                                <tr>
                                    <td></td>
                                    <td colspan="1">Prive</td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-left" colspan="2">Penambahan Modal</td>
                                <td></td>
                                <td class="text-left penambahan-modal">{{ 'Rp. ' . substr(number_format($laba + $prive , 2, ',', '.'),0,-3) }}</td>
                            </tr>
                        </tbody>
                            </tr>
                                <th colspan="2" class="text-right">Total Modal Akhir</th>
                                <th class="text-right" id="jumlah_modal_debit"></th>
                                <th class="text-right" id="jumlah_modal_kredit"></th>
                                <th class="text-right" id="modal_akhir"></th>
                            <tr>
                                {{-- <tr>
                                    <th colspan="2" class="text-right">Total Utang Lancar</th>
                                    <th class="text-right" id="jumlah_utang_lancar_debit"></th>
                            ...
                            <tfoot class="bg-primary text-white">
                                <tr>
                                    <th colspan="4" class="text-right">Total Kewajiban Dan Modal Akhir</th>
...
<script>
    $(document).ready(function () {
        ...
        $("#modal_akhir").html('Rp. ' + new Intl.NumberFormat('id-ID').format(jumlah('modal_neraca_saldo_debit') + jumlah('modal_neraca_saldo_kredit') +  jumlah('penambahan-modal')));
        ...
        $("#total_modal").html('Rp. ' + new Intl.NumberFormat('id-ID').format(angka($("#jumlah_utang_lancar").html()) + angka($("#jumlah_utang_tetap").html()) + jumlah('modal_neraca_saldo_debit') + jumlah('penambahan-modal')));
        kriteria();
