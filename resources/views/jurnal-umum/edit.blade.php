                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('transaksi.index') }}?page={{ request('page') }}" class="btn btn-success" data-toggle="tooltip" title="Kembali"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid mt--7">
    <div class="card bg-secondary shadow h-100">
        <div class="card-body">
            <form autocomplete="off" action="{{ route('jurnal-umum.update', $jurnal_umum->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" name="debit_atau_kredit" id="debit_kredit">
                                ...
                                <option value="1" @if ($jurnal_umum->debit_atau_kredit == '1') selected @endif>Debit</option>
                                <option value="2" @if ($jurnal_umum->debit_atau_kredit == '2') selected @endif>Kredit</option>
                        </select>
                        <span class="invalid-feedback font-weight-bold"></span>
                    </div>
                </div>
