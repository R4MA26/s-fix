...
class AkunSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Akun::create([
            "kelompok_akun_id" => 1,
            "kode" => "1211",
            "nama" => "Akumulasi Penyusutan Peralatan Perusahaan",
            "post_saldo" => 2,
            "post_penyesuaian" => 2,
            "post_laporan" => 1,
            "kelompok_laporan_posisi_keuangan" => 2,
        ...
        Akun::create([
            "kelompok_akun_id" => 6,
            "kode" => "6120",
            "nama" => "Beban Perlengkapan Perusahaan",
            "post_saldo" => 1,
            "post_penyesuaian" => 1,
            "post_laporan" => 2,
            "kelompok_laporan_posisi_keuangan" => null,
        ...
        Akun::create([
            "kelompok_akun_id" => 6,
            "kode" => "6140",
            "nama" => "Beban Penyusutan Peralatan Perusahaan",
            "post_saldo" => 1,
            "post_penyesuaian" => 1,
            "post_laporan" => 2,
            "kelompok_laporan_posisi_keuangan" => null,
